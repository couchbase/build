...
./restart_jenkinsdocker.py couchbasebuild/server-centos6-build:20180507 vulcan-centos6 5225 server.jenkins.couchbase.com
./restart_jenkinsdocker.py couchbasebuild/server-ubuntu16-build:20180507 zz-server-lightweight-backup 5322 server.jenkins.couchbase.com
...
./restart_jenkinsdocker.py couchbasebuild/server-centos7-build:20180507 vulcan-centos7 5228 server.jenkins.couchbase.com
...
./restart_jenkinsdocker.py couchbasebuild/server-debian8-build:20180507 vulcan-debian8 5230 server.jenkins.couchbase.com
