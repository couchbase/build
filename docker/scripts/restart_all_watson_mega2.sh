...
./restart_jenkinsdocker.py ceejatec/ubuntu-1604-couchbase-build:20180202 vulcan-ubuntu16.04 5239 server.jenkins.couchbase.com
# Primary zz-server-lightweight running on mega2 (same port as backup on mega3)
./restart_jenkinsdocker.py ceejatec/ubuntu-1604-couchbase-build:20180202 zz-server-lightweight 5322 server.jenkins.couchbase.com
