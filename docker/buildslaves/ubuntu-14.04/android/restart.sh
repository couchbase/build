...
docker run --name="mobile-android" -v /home/couchbase/jenkinsdocker-ssh:/ssh -p 2422:22 -d ceejatec/ubuntu1404-mobile-android-docker:20160712

docker stop mobile-java
docker rm -f mobile-java
docker run --name="mobile-java" -v /home/couchbase/jenkinsdocker-ssh:/ssh -p 2424:22 -d ceejatec/ubuntu1404-mobile-android-docker:20160712
