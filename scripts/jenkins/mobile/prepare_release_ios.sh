...
if [[ ${EDITION} =~ 'community' ]]
  then
    IOS_ZIP_SRC=cblite_ios_${BLD_NUM}-${EDITION}.zip
    IOS_ZIP_DST=cblite_ios_${REL_NUM}-${EDITION}.zip
else
    IOS_ZIP_SRC=cblite_ios_${BLD_NUM}.zip
    IOS_ZIP_DST=cblite_ios_${REL_NUM}.zip
fi
