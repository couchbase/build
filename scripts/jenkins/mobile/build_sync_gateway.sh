...
echo ${WORKSPACE}/build/scripts/cgi/set_jenkins_default_param.pl  -j build_sync_gateway_${GITSPEC}_POST     -p ${LAST_GOOD_PARAM} -v ${VERSION}
     ${WORKSPACE}/build/scripts/cgi/set_jenkins_default_param.pl  -j build_sync_gateway_${GITSPEC}_POST     -p ${LAST_GOOD_PARAM} -v ${VERSION}
