...
@IF NOT DEFINED SKIP_UNIT_TESTS (
    cd testrunner
    python scripts/start_cluster_and_run_tests.sh b/resources/dev-single-node.ini conf/view-conf/py-view-pre-merge.conf
    python scripts/start_cluster_and_run_tests.sh b/resources/dev-4-nodes.ini conf/view-conf/py-view-pre-merge.conf
) ELSE (
    @echo ============================================
