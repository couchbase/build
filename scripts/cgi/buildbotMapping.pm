...
my $usage="\n".'use:  buildbotMapping::get_builder( platform, bits, branch)'."\n\n"
              ...
              .'      bits      : 32, 64'."\n"
              .'      branch    : 2.0.0, 2.0.1, 2.0.2, 2.1.0, 2.1.1, master'."\n";
