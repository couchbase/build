...
my %valid = ( 'couchbase-cli'  => { 'gerrit'   => { "250"    => "couchbase-cli-gerrit-250",
               ...
               'ns_server'     => { 'gerrit'   => { "250"    => "ns_server-gerrit-250",
                                                    "2.5.0"  => "ns_server-gerrit-250",
                                                    "300"    => "ns_server-gerrit-300",
                                                    "3.0.0"  => "ns_server-gerrit-300",
                                                    "0.0.0"  => "ns_server-gerrit-master",
                                                    "master" => "ns_server-gerrit-master",
                                  }               },
