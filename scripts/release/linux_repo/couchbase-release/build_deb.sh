...
sudo rm -rf deb/couchbase-release-1.0-0
git checkout deb/couchbase-release-1.0-0

popd

cp $thisdir/deb/couchbase-release-1.0-0.deb ./couchbase-release-1.0-0-amd64.deb
